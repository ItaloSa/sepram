...
<html lang="pt" ng-app="sepram" ng-controller="sepramCtrl">
	<head>
		<?php
            include "head.php"
        ?>
		<title>Perfil - {{notificacoes2[2].nome}}</title>
	</head>
	<body class="bg">
		<div class="corpo">
			<!--nav-->
							...
							<div class="conteudo">
								<div class="row">
									<div class="col col-6 col-12-m perf">
										<div class="perf-img">
											<img src="{{notificacoes2[2].foto}}" alt="">
										</div>
										<div class="perf-name">
											<h1>{{notificacoes2[2].nome}}</h1>
											<p>{{notificacoes2[2].email}}</p>
											<span><i class="fa fa-map-marker" aria-hidden="true" style="margin-right: 10px;"></i>{{notificacoes2[2].localidade}}</span>	
										</div>
									</div>
									<div class="col col-6 col-12-m perf">
										<div class="perf-sobre">
											<h4>Sobre:</h4>
											<p>"Estudante de Gestão de TI na Estácio, Técnico em MSI no IFPE, atuo como voluntária numa ONG na area administrativa."</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col col-12">
								<div class="padding-20">
									<section class="padding-10">
										<h4>Habilidades:</h4>
										<div class="proj-hab">
											<a href="#"><span>{{notificacoes2[2].hab1}}</span></a>
											<a href="#"><span>{{notificacoes2[2].hab2}}</span></a>
											<a href="#"><span>{{notificacoes2[2].hab3}}</span></a>
										</div>
									</section>
								</div>
							</div>
